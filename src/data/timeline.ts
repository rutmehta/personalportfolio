...
Quantum computing fascinates me because it represents a fundamentally different paradigm of computation. Understanding it changes how you think about all computation.`,
  ...
  },
  {
    ...
    type: 'company',
    description: 'AI and product at Endex.ai. Building fully autonomous AI analysts and coworkers.',
    writeup: `Joined Endex.ai as Member of Technical Staff. Agent R&D, product development and innovation, and agent evals.`,
    link: 'https://endex.ai',
    relatedIds: ['roam'],
  },
];
